  ...
  computed: {
    mix: {
      ...
      set(value) {
        ...
        this.$store.state.buffer.material.uniforms.mixValue.value = parseFloat(value);
      }
    },
    opacity: {
      get() {
      ...
      set(value) {
        ...
        this.$store.state.buffer.material.uniforms.globalOpacity.value = parseFloat(value);
      }
    }
  }
};
